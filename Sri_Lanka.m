...
%% xxxxx Power Plant Start


% xxxxx End


%% yyyyyy Power Plant Start
...
Plant_S_nom = [LAK_S_nom, LAK_S_nom, LAK_S_nom , SAM_Unit_S_nom , SAM_Unit_S_nom]; 

% 2. Plant Inertias (Seconds)
Plant_H     = [ LAK_H,   LAK_H,   LAK_H, SAM_H, SAM_H]; 
